                  ...
                  {coach.socialMedia && Object.values(coach.socialMedia).some(link => link) && (
                    <div className="flex justify-center space-x-2 mb-4">
                      ...
                      {coach.socialMedia.twitch && (
                        <a href={coach.socialMedia.twimport React, { useState, useEffect } from 'react';
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-purple-600 rounded flex items-center justify-center">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <path d="M20.571 4.714c-2.329 0-4.428 1.143-4.428 2.571v.857c0 .629.514 1.143 1.143 1.143s1.143-.514 1.143-1.143v-.857c0-.465.643-.857 1.143-.857s1.143.392 1.143.857v9.43c0 .465-.643.857-1.143.857s-1.143-.392-1.143-.857v-.858c0-.628-.514-1.142-1.143-1.142s-1.143.514-1.143 1.142v.858c0 1.428 2.1 2.571 4.428 2.571 2.329 0 4.429-1.143 4.429-2.571V7.285C25 5.857 22.9 4.714 20.571 4.714z"/>
                  </svg>
                </div>
                <input
                  type="url"
